    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="shadow-sm rounded-none border-t-0 border-l border-r-0 border-b">
        <div className="flex flex-col p-4 gap-2 text-center">
          ...
          <DropdownMenuSeparator />
          <Link className="text-lg sm:text-xl hover:text-muted" href="/">Solo</Link>
          <DropdownMenuSeparator />
          <Link className="text-lg sm:text-xl hover:text-muted" href="/multiplayer">Multiplayer</Link>
        </div>
      </DropdownMenuContent>
    </DropdownMenu>
  )
              ...
              <nav className="w-full flex justify-center py-4 border-b border-b-foreground/10">
                <div className="flex flex-row justify-between items-center w-full mx-12 sm:w-1/2 gap-12">
                  ...
                  <div className="hidden sm:flex flex-row gap-8">
                    ...
                    <Link className="text-lg sm:text-xl hover:text-muted whitespace-nowrap" href="/">Solo</Link>
                    <Link className="text-lg sm:text-xl hover:text-muted whitespace-nowrap" href="/multiplayer">Multiplayer</Link>
                  </div>
